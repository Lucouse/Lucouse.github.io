  ...
  Vue.projectAPIInit = function (callBack) {
    ...
    function init (callBack) {
      ...
      var isInitialized = setInterval(function () {
        if (
          flg.configInitFlg &&
          flg.projectInfoInitFlg &&
          flg.recommendArticleInitFlg &&
          flg.articlesInitFlg &&
          flg.aboutMeInitFlg &&
          flg.hotRecommendArticleInitFlg
        ) {
          callBack()
    ...
    function getRecommendArticle () {
      commonFetch(
        '/static/DB/recommend_article.json',
        'recommend_article',
        function () {
    ...
    function getHotRecommendArticle () {
      commonFetch(
        '/static/DB/hot_recommend_article.json',
        'hot_recommend_article',
        function () {
